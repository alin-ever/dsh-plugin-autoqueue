...
export function validateSchedule(value) {
  ...
  if (date.getFullYear() !== year || date.getMonth() + 1 !== month || date.getDate() !== day ||
    ...
    throw new Error("schedule 日期时间无效");
  }
  return schedule;
}
 ...
 * <!-- deadline: 0 21 * * * -->
 * @param {string} raw
 * @returns {{ cron?: string, deadline?: string }}
 */
...
/** @typedef {{ key: string, path: string, raw: string, body: string, schedule?: { cron?: string, deadline?: string, schedule?: string } }} TaskFile */
