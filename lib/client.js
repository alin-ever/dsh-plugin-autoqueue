...
`));
      ...
      h7(
        ...
        !showTemplates[0] && h7(
          ...
          h7(
            ...
            h7(CronField, { label: "\u5B9A\u65F6\u8C03\u5EA6", value: cron[0], onChange: cron[1], presets: CRON_PRESETS, placeholder: "0 8 * * *" }),
  ...
  function ConfigPanel(props) {
    ...
    function handleSave(e5) {
      ...
      saving[1](true);
      saveError[1]("");
      Promise.all(ops).then(props.onClose).catch(function(e6) {
  ...
  function CompactHeader(props) {
    return h8(
      ...
      props.message && h8("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 px-3 py-1.5 rounded-b-lg bg-aq-navy text-white text-xs shadow-lg z-50" }, props.message),
    ...
    return h8(
      ...
      h8(
        ...
        h8(
          ...
          task.status !== "running" && !task.archivedAt && h8("button", { style: actionBtnStyle, className: "hover:bg-aq-surface-alt", onClick: function(e5) {
            e5.stopPropagation();
          ...
          ["pending", "failed", "stopped", "interrupted"].indexOf(task.status) >= 0 && !task.archivedAt && h8("button", { style: Object.assign({}, actionBtnStyle, { color: "var(--aq-red, #b42318)" }), className: "hover:bg-aq-red-soft", onClick: function(e5) {
            e5.stopPropagation();
