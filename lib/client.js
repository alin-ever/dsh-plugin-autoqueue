    ...
    function getSnapshot() {
      ...
      if (navGroup === "archived") {
        ...
        if (navGroup === "cron") scoped = scoped.filter(function(t6) {
          return t6.taskType === "cron";
        });
        else if (navGroup === "schedule") scoped = scoped.filter(function(t6) {
          return t6.taskType === "schedule";
        });
        else if (navGroup === "manual") scoped = scoped.filter(function(t6) {
          return t6.taskType === "manual";
        });
        else if (navGroup === "active") scoped = scoped.filter(function(t6) {
          return t6.status === "pending" || t6.status === "running" || t6.status === "interrupted";
        });
      }
      var scopeCounts = {};
...
`));
  ...
  var de = "span";
  function pe(u11, b5) {
    let f11 = useId(), y4 = u2(), T5 = a(), { id: h13 = y4 || `headlessui-checkbox-${f11}`, disabled: o9 = T5 || false, autoFocus: i7 = false, checked: C9, defaultChecked: k5, onChange: x7, name: d5, value: g3, form: E7, indeterminate: l8 = false, tabIndex: v3 = 0, ...P4 } = u11, r10 = l3(k5), [a15, t6] = b2(C9, x7, r10 != null ? r10 : false), D4 = N(), R2 = w2(), A4 = p(), [F2, p6] = useState(false), c11 = o3(() => {
  ...
  init_react_shim();
  var C6 = 30;
  function k3(o9, f11, h13) {
    let m6 = s2(h13), s12 = useCallback(function(e7, c11) {
...
`)), [];
  ...
  function Te(e7, t6) {
    let n8 = s2(e7), l8 = useRef([]), S6 = f9(), R2 = p(), d5 = o3((o9, i7 = C.Hidden) => {
    ...
    }), C9 = useRef([]), p6 = useRef(Promise.resolve()), h13 = useRef({ enter: [], leave: [] }), g3 = o3((o9, i7, a15) => {
      C9.current.splice(0), t6 && (t6.chains.current[i7] = t6.chains.current[i7].filter(([s12]) => s12 !== o9)), t6 == null || t6.chains.current[i7].push([o9, new Promise((s12) => {
        ...
        Promise.all(h13.current[i7].map(([r10, f11]) => f11)).then(() => s12());
      })]), i7 === "enter" ? p6.current = p6.current.then(() => t6 == null ? void 0 : t6.wait.current).then(() => a15(i7)) : a15(i7);
    }), v3 = o3((o9, i7, a15) => {
      Promise.all(h13.current[i7].splice(0).map(([s12, r10]) => r10)).then(() => {
        var s12;
        (s12 = C9.current.shift()) == null || s12();
      }).then(() => a15(i7));
    });
    return useMemo(() => ({ children: l8, register: y4, unregister: d5, onStart: g3, onStop: v3, wait: p6, chains: h13 }), [y4, d5, l8, g3, v3, h13, p6]);
  }
  var de2 = Fragment, fe = A.RenderStrategy;
  function Fe(e7, t6) {
    var ee2, te2;
    let { transition: n8 = true, beforeEnter: l8, afterEnter: S6, beforeLeave: R2, afterLeave: d5, enter: y4, enterFrom: C9, enterTo: p6, entered: h13, leave: g3, leaveFrom: v3, leaveTo: o9, ...i7 } = e7, [a15, s12] = useState(null), r10 = useRef(null), f11 = ue(e7), U3 = y(...f11 ? [r10, t6, s12] : t6 === null ? [] : [t6]), H4 = (ee2 = i7.unmount) == null || ee2 ? C.Unmount : C.Hidden, { show: u11, appear: z3, initial: K3 } = He(), [m6, j7] = useState(u11 ? "visible" : "hidden"), Q2 = Ae(), { register: A4, unregister: F2 } = Q2;
    n(() => A4(r10), [A4, r10]), n(() => {
    ...
    let pe2 = /* @__PURE__ */ (() => !(!n8 || !f11 || !G4 || ce))(), [, T5] = N2(pe2, a15, u11, { start: Z2, end: $2 }), Ce3 = m({ ref: U3, className: ((te2 = t2(i7.className, Y2 && y4, Y2 && C9, T5.enter && y4, T5.enter && T5.closed && C9, T5.enter && !T5.closed && p6, T5.leave && g3, T5.leave && !T5.closed && v3, T5.leave && T5.closed && o9, !T5.transition && u11 && h13)) == null ? void 0 : te2.trim()) || void 0, ...x3(T5) }), N3 = 0;
  ...
  function Ie(e7, t6) {
    ...
    let [h13, g3] = useState(n8 ? "visible" : "hidden"), v3 = Te(() => {
      n8 || g3("hidden");
  ...
  function xe(n8) {
    var c11;
    let [t6, a15] = useState(null), [f11, h13] = V2(), [b5, o9] = H2(), s12 = useMemo(() => ({ switch: t6, setSwitch: a15 }), [t6, a15]), T5 = {}, y4 = n8, p6 = K();
    return react_shim_default.createElement(o9, { name: "Switch.Description", value: b5 }, react_shim_default.createElement(h13, { name: "Switch.Label", value: f11, props: { htmlFor: (c11 = s12.switch) == null ? void 0 : c11.id, onClick(u11) {
  ...
  function Le2(n8, t6) {
    var g3;
    let a15 = useId(), f11 = u2(), h13 = a(), { id: b5 = f11 || `headlessui-switch-${a15}`, disabled: o9 = h13 || false, checked: s12, defaultChecked: T5, onChange: y4, name: p6, value: c11, form: u11, autoFocus: S6 = false, ...C9 } = n8, _5 = useContext(E6), [L4, R2] = useState(null), G4 = useRef(null), A4 = y(G4, t6, _5 === null ? null : _5.setSwitch, R2), l8 = l3(T5), [d5, r10] = b2(s12, y4, l8 != null ? l8 : false), F2 = p(), [H4, P4] = useState(false), D4 = o3(() => {
  ...
  function timeAgo(iso) {
    ...
    var h13 = Math.floor(m6 / 60);
    if (h13 < 24) return h13 + " \u5C0F\u65F6\u524D";
    return Math.floor(h13 / 24) + " \u5929\u524D";
  }
  ...
  function localDatetimeString(iso) {
    ...
    var p6 = function(n8) {
      return String(n8).padStart(2, "0");
    };
    return d5.getFullYear() + "-" + p6(d5.getMonth() + 1) + "-" + p6(d5.getDate()) + "T" + p6(d5.getHours()) + ":" + p6(d5.getMinutes());
  }
    ...
    return h7(
      ...
      h7(
        ...
        h7(
          ...
          {
            transition: true,
            className: (isDrawer ? "h-full w-[min(880px,94vw)] bg-aq-paper shadow-2xl transition duration-200 ease-out data-[closed]:translate-x-4 data-[closed]:opacity-0" : "w-[min(930px,94vw)] max-h-[min(88vh,900px)] overflow-y-auto rounded-2xl bg-aq-paper shadow-2xl border border-aq-line transition duration-200 ease-out data-[closed]:scale-95 data-[closed]:opacity-0") + (props.className ? " " + props.className : "")
          },
  ...
  function TaskDetailPanel(props) {
    ...
    return h8(
      ...
      h8(
        ...
        h8(
          "div",
          { className: "flex-shrink-0 flex gap-2 px-6 py-3 border-t border-aq-line bg-aq-paper" },
          value.status === "pending" && h8("button", { className: "aq-btn aq-btn-ghost text-xs", onClick: function() {
            props.onClose();
            controller.openEdit(value.key);
          } }, "\u7F16\u8F91"),
          value.status === "pending" && h8("button", { className: "aq-btn aq-btn-ghost text-xs text-aq-red", onClick: function() {
            requestAction("delete");
          } }, "\u5220\u9664"),
          value.status === "running" && value.stopPending !== true && h8("button", { className: "aq-btn aq-btn-ghost text-xs text-aq-red", onClick: function() {
            requestAction("stop");
          } }, "\u505C\u6B62"),
          ["done", "failed", "stopped", "interrupted"].indexOf(value.status) >= 0 && !value.archivedAt && h8("button", { className: "aq-btn aq-btn-ghost text-xs text-aq-green", onClick: function() {
            requestAction("rerun");
          } }, "\u91CD\u65B0\u6267\u884C"),
          value.status !== "running" && !value.archivedAt && h8("button", { className: "aq-btn aq-btn-ghost text-xs", onClick: function() {
            doAction("archive");
          } }, "\u5F52\u6863"),
          value.archivedAt && h8("button", { className: "aq-btn aq-btn-ghost text-xs", onClick: function() {
            doAction("restore");
          } }, "\u6062\u590D"),
          h8("span", { className: "flex-1" }),
          sessionId && h8("button", { className: "aq-btn aq-btn-primary text-xs", onClick: function() {
            props.onClose();
  ...
  function OverviewTab(props) {
    ...
    return h8(
      ...
      task.body && h8(
        ...
        h8(
          "div",
          { className: "max-h-60 overflow-auto p-3 rounded-xl border border-aq-line bg-aq-surface-alt" },
      ...
      h8(
        ...
        executions.length === 0 ? h8("p", { className: "text-sm text-aq-muted py-4 text-center" }, "\u8FD8\u6CA1\u6709\u6267\u884C\u8BB0\u5F55") : h8(
          ...
          executions.slice().reverse().map(function(ex, i7) {
            var cfg = STATUS_CONFIG2[ex.result] || { label: ex.result || "\u6267\u884C\u4E2D", color: "#596579" };
            return h8(
              "div",
    ...
    return h8(
      ...
      h8(
        ...
        h8(
          Grid,
          null,
          h8(Fact, { label: "\u5FAA\u73AF\u8C03\u5EA6", value: task.cron ? cronToHuman(task.cron) : "\u672A\u8BBE\u7F6E" }),
          h8(Fact, { label: "\u4E00\u6B21\u6027\u5B9A\u65F6", value: task.schedule ? formatIso(task.schedule) : "\u672A\u8BBE\u7F6E" }),
          h8(Fact, { label: "\u622A\u6B62\u7A97\u53E3", value: task.deadline ? cronToHuman(task.deadline) : "\u672A\u8BBE\u7F6E" }),
          h8(Fact, { label: "\u81EA\u52A8\u5F52\u6863", value: task.autoArchive === false ? "\u5173\u95ED" : "\u5F00\u542F" })
        )
      ),
      h8(
        Section,
      ...
      h8(
        ...
        h8("p", { className: "text-xs text-aq-blue/70 mt-0.5" }, "\u4EFB\u52A1\u4F7F\u7528\u72EC\u7ACB\u5DE5\u4F5C\u76EE\u5F55\uFF1B\u4F60\u4F7F\u7528 DSH \u65F6\uFF0C\u540E\u53F0\u4EFB\u52A1\u4F1A\u81EA\u52A8\u6682\u505C\u3002")
      )
    );
  }
  ...
  function Grid(props) {
    return h8(
      "div",
      { className: "grid grid-cols-2 gap-px overflow-hidden rounded-xl border border-aq-line bg-aq-line" },
      (props.children && props.children.length ? props.children : [props.children]).map(function(child, i7) {
        return h8("div", { key: i7, className: "p-3 bg-aq-paper" }, child);
      })
    );
  }
  function Fact(props) {
  ...
  // client/src/components/TemplatePicker.jsx
  function h9() {
    return window.__React.createElement.apply(window.__React, arguments);
  }
  function TemplatePicker(props) {
    var transport = props.transport;
    var stage = window.__React.useState("browse");
    var templates = window.__React.useState([]);
    var loading = window.__React.useState(true);
    var loadError = window.__React.useState("");
    var selected = window.__React.useState(null);
    var paramValues = window.__React.useState({});
    var resolved = window.__React.useState("");
    var resolving = window.__React.useState(false);
    var resolveError = window.__React.useState("");
    window.__React.useEffect(function() {
      var cancelled = false;
    ...
    function pick(tpl) {
      selected[1](tpl);
      var defs = {};
      (tpl.parameters || []).forEach(function(p6) {
        if (p6.default !== void 0) defs[p6.key] = p6.default;
      });
      paramValues[1](defs);
      stage[1]("params");
    }
    ...
    if (stage[0] === "browse") {
      return h9(BrowseStage, { templates: templates[0], loading: loading[0], error: loadError[0], onPick: pick, onSkip: function() {
        props.onCancel();
      } });
    }
    if (stage[0] === "params") {
      return h9(ParamsStage, { template: selected[0], values: paramValues[0], onChange: setParam, onSubmit: doResolve, onBack: function() {
        stage[1]("browse");
      }, resolving: resolving[0], error: resolveError[0] });
    }
    return h9(PreviewStage, { template: selected[0], content: resolved[0], onConfirm: confirm, onBack: function() {
      stage[1]("params");
    } });
  }
  function BrowseStage(props) {
    if (props.loading) {
      return h9(
        "div",
        { className: "flex flex-col items-center justify-center py-12 gap-3" },
        h9("div", { className: "w-5 h-5 border-2 border-aq-line-2 border-t-aq-blue rounded-full animate-spin" }),
        h9("p", { className: "text-sm text-aq-muted" }, "\u6B63\u5728\u52A0\u8F7D\u6A21\u677F\u5E93\u2026")
      );
    }
    if (props.error) {
      return h9(
        "div",
        { className: "text-center py-10" },
        h9("p", { className: "text-sm text-aq-red mb-3" }, props.error),
        h9("button", { className: "aq-btn aq-btn-primary", onClick: props.onSkip }, "\u4F7F\u7528\u7A7A\u767D\u8868\u5355")
      );
    }
    if (!props.templates.length) {
      return h9(
        "div",
        { className: "text-center py-10" },
        h9("p", { className: "text-sm text-aq-muted mb-3" }, "\u6A21\u677F\u5E93\u6682\u65E0\u53EF\u7528\u6A21\u677F"),
        h9("button", { className: "aq-btn aq-btn-primary", onClick: props.onSkip }, "\u4F7F\u7528\u7A7A\u767D\u8868\u5355")
      );
    }
    var cats = {};
    props.templates.forEach(function(t6) {
      var c11 = t6.category || "\u5176\u4ED6";
      if (!cats[c11]) cats[c11] = [];
      cats[c11].push(t6);
    });
    return h9(
      "div",
      ...
      h9(
        "div",
        { className: "mb-5" },
        h9("h3", { className: "text-base font-bold text-aq-ink mb-1" }, "\u4ECE\u6A21\u677F\u5F00\u59CB"),
        h9("p", { className: "text-sm text-aq-muted" }, "\u9009\u62E9\u4E00\u4E2A\u6A21\u677F\uFF0C\u586B\u5199\u53C2\u6570\u540E\u5373\u53EF\u521B\u5EFA\u4EFB\u52A1\u3002"),
        h9("button", { className: "mt-3 text-sm text-aq-blue hover:underline", onClick: props.onSkip }, "\u8DF3\u8FC7\uFF0C\u4F7F\u7528\u7A7A\u767D\u8868\u5355 \u2192")
      ),
      Object.keys(cats).map(function(cat) {
        return h9(
          "div",
          { key: cat, className: "mb-5" },
          h9("h4", { className: "text-xs font-semibold text-aq-faint uppercase tracking-wide mb-2" }, cat),
          h9(
            "div",
            ...
            cats[cat].map(function(tpl) {
              return h9(
                ...
                h9("div", { className: "text-sm font-semibold text-aq-ink group-hover:text-aq-blue transition mb-1" }, tpl.name),
                h9("p", { className: "text-xs text-aq-muted line-clamp-2" }, tpl.description || "\u6682\u65E0\u63CF\u8FF0"),
                (tpl.parameters || []).length > 0 && h9("span", { className: "inline-block mt-2 text-xs text-aq-faint bg-aq-surface-alt px-2 py-0.5 rounded" }, (tpl.parameters || []).length, " \u4E2A\u53C2\u6570")
              );
            })
          )
        );
    ...
    return h9(
      ...
      h9(
        ...
        h9(
          "div",
          null,
          h9("h3", { className: "text-base font-bold text-aq-ink" }, tpl.name),
          tpl.description && h9("p", { className: "text-sm text-aq-muted mt-0.5" }, tpl.description)
        ),
        h9("button", { className: "text-sm text-aq-blue hover:underline", onClick: props.onBack }, "\u2190 \u8FD4\u56DE\u6A21\u677F\u5E93")
      ),
      h9(
        "form",
        { onSubmit: props.onSubmit },
        props.error && h9("div", { className: "p-3 mb-4 rounded-lg bg-aq-red-soft text-sm text-aq-red" }, props.error),
        params.length === 0 && h9("p", { className: "text-sm text-aq-muted mb-4" }, "\u6B64\u6A21\u677F\u65E0\u9700\u53C2\u6570\uFF0C\u76F4\u63A5\u9884\u89C8\u5373\u53EF\u3002"),
        params.map(function(p6) {
          return h9(
            "div",
            { key: p6.key, className: "mb-4" },
            h9(
              "label",
              { className: "block text-sm font-semibold text-aq-ink-2 mb-1.5" },
              p6.label || p6.key,
              p6.required ? h9("span", { className: "text-aq-red ml-1" }, "*") : null
            ),
            p6.description && h9("p", { className: "text-xs text-aq-faint mb-1.5" }, p6.description),
            h9("input", {
              type: "text",
              value: props.values[p6.key] || "",
              onChange: function(e7) {
                props.onChange(p6.key, e7.target.value);
              },
              placeholder: p6.default || "\u8BF7\u8F93\u5165 " + (p6.label || p6.key),
        ...
        h9(
          "div",
          { className: "flex justify-between pt-4 border-t border-aq-line" },
          h9("button", { type: "button", className: "aq-btn aq-btn-ghost", onClick: props.onBack }, "\u8FD4\u56DE"),
          h9("button", { type: "submit", className: "aq-btn aq-btn-primary", disabled: props.resolving }, props.resolving ? "\u89E3\u6790\u4E2D\u2026" : "\u9884\u89C8\u4EFB\u52A1")
        )
      )
    );
  }
    ...
    return h9(
      ...
      h9(
        ...
        h9(
          "div",
          null,
          h9("h3", { className: "text-base font-bold text-aq-ink" }, "\u9884\u89C8\uFF1A", props.template.name),
          h9("p", { className: "text-sm text-aq-muted mt-0.5" }, "\u786E\u8BA4\u4EFB\u52A1\u5185\u5BB9\u540E\u521B\u5EFA")
        ),
        h9("button", { className: "text-sm text-aq-blue hover:underline", onClick: props.onBack }, "\u4FEE\u6539\u53C2\u6570")
      ),
      h9(
        "div",
        { className: "max-h-80 overflow-auto p-4 rounded-xl border border-aq-line bg-aq-surface-alt" },
        h9("pre", { className: "text-xs font-mono text-aq-ink-2 whitespace-pre-wrap break-words m-0" }, props.content || "\uFF08\u7A7A\u5185\u5BB9\uFF09")
      ),
      h9(
        "div",
        { className: "flex justify-between pt-4 mt-4 border-t border-aq-line" },
        h9("button", { className: "aq-btn aq-btn-ghost", onClick: props.onBack }, "\u8FD4\u56DE\u4FEE\u6539"),
        h9("button", { className: "aq-btn aq-btn-primary", onClick: props.onConfirm }, "\u786E\u8BA4\u521B\u5EFA")
      )
    );
  }
  ...
  function NewTaskModal(props) {
    ...
    return h10(
      DialogShell,
      { open: true, onClose: props.onClose, title: "\u65B0\u5EFA\u65E0\u4EBA\u503C\u5B88\u4EFB\u52A1", variant: "modal", className: "w-[min(1100px,94vw)]" },
      stage[0] === "template" && h10(TemplatePicker, {
        transport,
      ...
      stage[0] === "form" && h10(
        "form",
        { className: "px-6 pb-6", onSubmit: handleSubmit },
        // ── 头部：来源提示 + 切换入口 ──
        fromTemplate[0] ? h10(
          "div",
          { className: "flex items-center gap-2 py-3 mb-1" },
          h10("span", { className: "aq-badge aq-badge-blue" }, fromTemplate[0].name),
          h10("span", { className: "text-sm text-aq-muted" }, "\u5DF2\u4ECE\u6A21\u677F\u586B\u5145\u5185\u5BB9"),
          h10("button", { type: "button", className: "ml-auto text-sm text-aq-blue hover:underline", onClick: function() {
            stage[1]("template");
          } }, "\u6362\u6A21\u677F")
        ) : h10(
          "div",
          { className: "flex items-center justify-between py-3 mb-1" },
          h10("span", { className: "text-sm text-aq-muted" }, "\u76F4\u63A5\u586B\u5199\u4EFB\u52A1\u5185\u5BB9"),
          h10("button", { type: "button", className: "text-sm text-aq-blue hover:underline", onClick: function() {
            stage[1]("template");
          } }, "\u4ECE\u6A21\u677F\u5F00\u59CB")
        ),
        error[0] && h10("div", { className: "p-3 mb-4 rounded-lg bg-aq-red-soft text-sm text-aq-red" }, error[0]),
        // ── 从模板来：紧凑确认模式 ──
        fromTemplate[0] && h10(
          "div",
          null,
          h10(
            "div",
            { className: "mb-4 p-3 rounded-xl border border-aq-line bg-aq-surface-alt" },
            h10(
              "div",
              { className: "flex items-center gap-2 mb-2" },
              h10("span", { className: "text-xs font-semibold text-aq-faint uppercase" }, "\u4EFB\u52A1\u5185\u5BB9"),
              h10("span", { className: "text-xs text-aq-muted" }, "\u7531\u6A21\u677F\u751F\u6210\uFF0C\u53EF\u76F4\u63A5\u521B\u5EFA")
            ),
            h10("pre", { className: "text-xs font-mono text-aq-ink-2 whitespace-pre-wrap break-words max-h-32 overflow-y-auto m-0" }, content[0])
          ),
          h10(
            "div",
            { className: "mb-4" },
            h10("label", { className: "block text-sm font-semibold text-aq-ink-2 mb-1.5" }, "\u8865\u5145\u8BF4\u660E\uFF08\u53EF\u9009\uFF09"),
            h10("textarea", {
              value: extraInstruction[0],
              onChange: function(e7) {
                extraInstruction[1](e7.target.value);
              },
          ...
          h10(
            ...
            h10(
              Field,
              { label: "\u4EFB\u52A1\u6807\u8BC6" },
              h10("input", { value: key[0], onChange: function(e7) {
                key[1](e7.target.value);
              }, placeholder: "\u81EA\u52A8\u751F\u6210", className: "aq-input" })
            ),
            h10(
              Field,
              { label: "\u4F18\u5148\u7EA7" },
              h10("input", { type: "number", min: "1", max: "10", value: priority[0], onChange: function(e7) {
        ...
        !fromTemplate[0] && h10(
          "div",
          null,
          h10("label", { className: "block text-sm font-semibold text-aq-ink-2 mb-1.5" }, "\u4EFB\u52A1\u5185\u5BB9\uFF08Markdown\uFF09"),
          h10("textarea", {
            value: content[0],
            onChange: function(e7) {
        ...
        h10(
          "div",
          { className: "grid grid-cols-2 gap-3 mt-4" },
          h10(CronField, { label: "\u5FAA\u73AF\u8C03\u5EA6", value: cron[0], onChange: cron[1], presets: CRON_PRESETS, placeholder: "0 8 * * *" }),
          h10(
            Field,
            { label: "\u4E00\u6B21\u6027\u5B9A\u65F6" },
            h10("input", { type: "datetime-local", value: schedule[0], onChange: function(e7) {
              schedule[1](e7.target.value);
            }, className: "aq-input" })
          )
        ),
        h10(CronField, { label: "\u6267\u884C\u622A\u6B62\u65F6\u95F4", value: deadline[0], onChange: deadline[1], presets: DEADLINE_PRESETS, placeholder: "0 21 * * *" }),
        // ── 高级设置 ──
        h10(
          "div",
          ...
          h10(
            ...
            h10("span", null, "\u66F4\u591A\u8BBE\u7F6E"),
            h10("span", { className: "text-aq-faint" }, advancedOpen[0] ? "\u2212" : "+")
          ),
          advancedOpen[0] && h10(
            "div",
            { className: "mt-3 grid grid-cols-3 gap-3" },
            h10(Field, { label: "\u6700\u591A\u63A8\u8FDB\u8F6E\u6570" }, h10("input", { type: "number", min: "1", max: "100", value: maxGoalRounds[0], onChange: function(e7) {
              maxGoalRounds[1](e7.target.value);
            }, className: "aq-input" })),
            h10(Field, { label: "\u6700\u591A\u81EA\u52A8\u6062\u590D" }, h10("input", { type: "number", min: "0", max: "10", value: maxBlockedResumes[0], onChange: function(e7) {
              maxBlockedResumes[1](e7.target.value);
            }, className: "aq-input" })),
            h10(Field, { label: "\u6700\u957F\u6267\u884C\uFF08\u5206\u949F\uFF09" }, h10("input", { type: "number", min: "10", max: "1440", value: timeoutMinutes[0], onChange: function(e7) {
          ...
          advancedOpen[0] && h10(
            "div",
            { className: "mt-3" },
            h10(Field, { label: "\u6700\u591A\u542F\u52A8\u5C1D\u8BD5\uFF081-10\uFF09" }, h10("input", { type: "number", min: "1", max: "10", value: maxAttempts[0], onChange: function(e7) {
          ...
          advancedOpen[0] && h10(
            ...
            h10(Field, { label: "Webhook URL" }, h10("input", { type: "url", value: webhook[0], onChange: function(e7) {
              webhook[1](e7.target.value);
            }, placeholder: "https://example.com/hook", className: "aq-input" })),
            h10(ToggleField, { checked: autoArchive[0], onChange: autoArchive[1], label: "\u5B8C\u6210\u540E\u81EA\u52A8\u5F52\u6863" }),
            h10(ToggleField, { checked: enableNotifications[0], onChange: function(v4) {
        ...
        h10(
          "div",
          { className: "flex justify-end gap-3 mt-6 pt-4 border-t border-aq-line" },
          fromTemplate[0] && h10("button", { type: "button", className: "aq-btn aq-btn-ghost", onClick: function() {
            stage[1]("template");
          }, disabled: submitting[0] }, "\u8FD4\u56DE\u6A21\u677F"),
          !fromTemplate[0] && h10("button", { type: "button", className: "aq-btn aq-btn-ghost", onClick: function() {
            stage[1]("template");
          }, disabled: submitting[0] }, "\u4ECE\u6A21\u677F\u5F00\u59CB"),
          h10("button", { type: "button", className: "aq-btn aq-btn-ghost", onClick: props.onClose, disabled: submitting[0] }, "\u53D6\u6D88"),
          h10("button", { type: "submit", className: "aq-btn aq-btn-primary", disabled: submitting[0] }, submitting[0] ? "\u521B\u5EFA\u4E2D\u2026" : "\u521B\u5EFA\u4EFB\u52A1")
        )
      )
    );
  }
  function EditTaskModal(props) {
    ...
    return h10(
      DialogShell,
      { open: true, onClose: props.onClose, title: "\u7F16\u8F91\u4EFB\u52A1 \xB7 " + task.key, variant: "modal", className: "w-[min(1100px,94vw)]" },
      h10(
        "form",
        { className: "px-6 pb-6", onSubmit: handleSubmit },
        h10("p", { className: "text-sm text-aq-muted mb-4" }, "\u4EC5\u5F85\u6267\u884C\u4EFB\u52A1\u53EF\u7F16\u8F91\uFF1B\u8FD0\u884C\u4E2D\u7684\u4EFB\u52A1\u8BF7\u5148\u505C\u6B62\u3002"),
        error[0] && h10("div", { className: "p-3 mb-4 rounded-lg bg-aq-red-soft text-sm text-aq-red" }, error[0]),
        h10("label", { className: "block text-sm font-semibold text-aq-ink-2 mb-1.5" }, "\u4EFB\u52A1\u5185\u5BB9\uFF08Markdown\uFF09"),
        h10("textarea", { value: content[0], onChange: function(e7) {
          content[1](e7.target.value);
        }, className: "w-full h-36 p-3 rounded-xl border border-aq-line-2 bg-aq-paper text-sm text-aq-ink resize-y focus:border-aq-blue focus:ring-2 focus:ring-aq-blue/10 outline-none" }),
        h10(
          "div",
          { className: "grid grid-cols-2 gap-3 mt-4" },
          h10(Field, { label: "\u4F18\u5148\u7EA7\uFF081-10\uFF09" }, h10("input", { type: "number", min: "1", max: "10", value: priority[0], onChange: function(e7) {
            priority[1](e7.target.value);
          }, className: "aq-input" })),
          h10(CronField, { label: "\u5FAA\u73AF\u8C03\u5EA6", value: cron[0], onChange: cron[1], presets: CRON_PRESETS, placeholder: "0 8 * * *" })
        ),
        h10(
          "div",
          { className: "grid grid-cols-2 gap-3 mt-4" },
          h10(Field, { label: "\u4E00\u6B21\u6027\u5B9A\u65F6" }, h10("input", { type: "datetime-local", value: schedule[0], onChange: function(e7) {
            schedule[1](e7.target.value);
          }, className: "aq-input" })),
          h10(CronField, { label: "\u6267\u884C\u622A\u6B62\u65F6\u95F4", value: deadline[0], onChange: deadline[1], presets: DEADLINE_PRESETS, placeholder: "0 21 * * *" })
        ),
        ...
        h10(
          ...
          h10(
            ...
            h10("span", null, "\u901A\u77E5"),
            h10("span", { className: "text-aq-faint" }, notifyOpen[0] ? "\u2212" : "+")
          ),
          notifyOpen[0] && h10(
            "div",
            { className: "mt-3 space-y-3" },
            ...
            h10(ToggleField, { checked: autoArchive[0], onChange: autoArchive[1], label: "\u5B8C\u6210\u540E\u81EA\u52A8\u5F52\u6863" }),
            h10(ToggleField, { checked: enableNotifications[0], onChange: function(v3) {
        ...
        h10(
          ...
          { className: "flex justify-end gap-3 mt-6 pt-4 border-t border-aq-line" },
          h10("button", { type: "button", className: "aq-btn aq-btn-ghost", onClick: props.onClose, disabled: submitting[0] }, "\u53D6\u6D88"),
          h10("button", { type: "submit", className: "aq-btn aq-btn-primary", disabled: submitting[0] }, submitting[0] ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58")
        )
      )
    );
  }
  function ConfigPanel(props) {
    ...
    return h10(
      DialogShell,
      { open: true, onClose: props.onClose, title: "\u8FD0\u884C\u8BBE\u7F6E", variant: "drawer", className: "w-[min(930px,96vw)]" },
      h10(
        "form",
        { className: "flex-1 min-h-0 px-6 pt-4 pb-0 overflow-y-auto", onSubmit: handleSave },
        saveError[0] && h10("div", { className: "p-3 mb-4 rounded-lg bg-aq-red-soft text-sm text-aq-red" }, saveError[0]),
        h10(
          Section2,
          { title: "\u6267\u884C\u9650\u5236" },
          h10(
            "div",
            { className: "grid grid-cols-2 gap-3" },
            h10(Field, { label: "\u6700\u5927\u5E76\u53D1\uFF081-8\uFF09" }, h10("input", { type: "number", min: "1", max: "8", value: maxConcurrent[0], onChange: function(e7) {
              maxConcurrent[1](e7.target.value);
            }, className: "aq-input" })),
            h10(Field, { label: "\u4EFB\u52A1\u8D85\u65F6\uFF08\u5206\u949F\uFF09" }, h10("input", { type: "number", min: "10", max: "1440", value: taskTimeoutMin[0], onChange: function(e7) {
        ...
        h10(
          ...
          h10(
            "div",
            { className: "grid grid-cols-2 gap-3" },
            h10(Field, { label: "\u6700\u591A\u542F\u52A8\u5C1D\u8BD5" }, h10("input", { type: "number", min: "1", max: "10", value: maxAttempts[0], onChange: function(e7) {
              maxAttempts[1](e7.target.value);
            }, className: "aq-input" })),
            h10(Field, { label: "\u8FDE\u7EED\u72B6\u6001\u5F02\u5E38\u6B21\u6570" }, h10("input", { type: "number", min: "1", max: "10", value: unknownThreshold[0], onChange: function(e7) {
          ...
          h10(
            "div",
            { className: "grid grid-cols-2 gap-3 mt-3" },
            h10(Field, { label: "\u9996\u6B21\u91CD\u8BD5\u7B49\u5F85\uFF08\u79D2\uFF09" }, h10("input", { type: "number", min: "5", max: "600", value: backoffBaseSec[0], onChange: function(e7) {
              backoffBaseSec[1](e7.target.value);
            }, className: "aq-input" })),
            h10(Field, { label: "\u6700\u957F\u91CD\u8BD5\u7B49\u5F85\uFF08\u79D2\uFF09" }, h10("input", { type: "number", min: "10", max: "3600", value: backoffMaxSec[0], onChange: function(e7) {
        ...
        h10(
          ...
          h10(
            "div",
            { className: "grid grid-cols-2 gap-3" },
            h10(Field, { label: "\u9ED8\u8BA4\u4F18\u5148\u7EA7" }, h10("input", { type: "number", min: "1", max: "10", value: priority[0], onChange: function(e7) {
              priority[1](e7.target.value);
            }, className: "aq-input" })),
            h10(Field, { label: "\u9ED8\u8BA4\u622A\u6B62\u65F6\u95F4\uFF08cron\uFF09" }, h10("input", { value: defaultDeadline[0], onChange: function(e7) {
          ...
          h10(
            "div",
            { className: "mt-3 space-y-3" },
            h10(ToggleField, { checked: autoArchive[0], onChange: autoArchive[1], label: "\u4EFB\u52A1\u7ED3\u675F\u540E\u81EA\u52A8\u5F52\u6863" }),
            h10(ToggleField, { checked: enableNotifications[0], onChange: function(v4) {
              enableNotifications[1](v4);
              if (v4) requestNotificationPermission();
            }, label: "\u6D4F\u89C8\u5668\u7ED3\u679C\u901A\u77E5" })
        ...
        h10(
          Section2,
          { title: "\u5B58\u50A8" },
          h10(Field, { label: "\u961F\u5217\u6839\u76EE\u5F55", help: "\u53EA\u8BFB\uFF0C\u7531\u542F\u52A8\u914D\u7F6E\u51B3\u5B9A" }, h10("input", { value: config.queueDir || "\u7531\u542F\u52A8\u914D\u7F6E\u51B3\u5B9A", disabled: true, className: "aq-input bg-aq-surface-alt text-aq-faint" })),
          h10(
            "div",
            { className: "mt-3" },
            h10(Field, { label: "AI \u76F4\u63A5\u64CD\u4F5C\u961F\u5217", help: "\u53EA\u8BFB\uFF0C\u5728\u63D2\u4EF6\u542F\u52A8\u914D\u7F6E\u4E2D\u8BBE\u7F6E" }, h10("input", { value: config.enableHostAiTools !== false ? "\u5DF2\u542F\u7528" : "\u5DF2\u5173\u95ED", disabled: true, className: "aq-input bg-aq-surface-alt text-aq-faint" }))
          )
        ),
        h10(
          "div",
          { className: "sticky bottom-0 flex justify-end gap-3 py-4 mt-2 border-t border-aq-line bg-aq-paper" },
          h10("button", { type: "button", className: "aq-btn aq-btn-ghost", onClick: props.onClose, disabled: saving[0] }, "\u53D6\u6D88"),
          h10("button", { type: "submit", className: "aq-btn aq-btn-primary", disabled: saving[0] }, saving[0] ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\u8BBE\u7F6E")
        )
      )
    );
  }
  function ConfirmModal(props) {
    return h10(
      DialogShell,
      { open: true, onClose: props.onCancel, title: props.title || "\u786E\u8BA4\u64CD\u4F5C", variant: "modal", className: "w-[min(630px,94vw)]" },
      h10(
        "div",
        { className: "px-6 pb-6" },
        h10("p", { className: "text-sm text-aq-ink-2 leading-relaxed" }, props.message),
        h10(
          "div",
          { className: "flex justify-end gap-3 mt-5 pt-4 border-t border-aq-line" },
          h10("button", { className: "aq-btn aq-btn-ghost", onClick: props.onCancel }, "\u53D6\u6D88"),
          h10("button", { className: "aq-btn " + (props.tone === "danger" ? "aq-btn-danger" : "aq-btn-primary"), onClick: props.onConfirm }, props.confirmLabel || "\u786E\u8BA4")
        )
      )
    );
  }
  function Field(props) {
    return h10(
      "div",
      null,
      props.label && h10("label", { className: "block text-sm font-semibold text-aq-ink-2 mb-1.5" }, props.label),
      props.children,
      props.help && h10("p", { className: "text-xs text-aq-faint mt-1" }, props.help)
    );
  }
  function ToggleField(props) {
    return h10(
      ...
      h10("span", { className: "text-sm text-aq-ink-2" }, props.label)
    );
  }
  function Section2(props) {
    return h10(
      ...
      h10("h4", { className: "text-sm font-bold text-aq-ink-2 mb-3" }, props.title),
      props.children
    );
  }
  function CronField(props) {
    ...
    return h10(
      "div",
      null,
      h10("span", { className: "block text-sm font-semibold text-aq-ink-2 mb-1.5" }, props.label),
      h10(
        "div",
        ...
        h10(
          ...
          (props.presets || []).map(function(p6) {
            return h10("option", { key: p6.value, value: p6.value }, p6.label);
          })
        ),
        h10("input", {
  ...
  function Workstation(props) {
    ...
    return h11(
      ...
      selected[0].length > 0 && h11(
        "div",
        { className: "flex items-center gap-2 px-4 py-2 bg-aq-blue-soft border-b border-aq-blue/20" },
        h11("span", { className: "text-xs font-semibold text-aq-blue mr-auto" }, "\u5DF2\u9009\u62E9 ", selected[0].length, " \u4E2A"),
        h11("button", { className: "text-xs font-semibold text-aq-blue hover:underline", onClick: function() {
          selected[1]([]);
        } }, "\u53D6\u6D88"),
        h11("button", { className: "aq-btn aq-btn-primary text-xs h-7 px-3", onClick: archiveSelected }, "\u6279\u91CF\u5F52\u6863")
      ),
      h11(CompactTaskList, {
        snap,
        tasks: visibleTasks,
      ...
      snap.showDetail && snap.detailTask && h11(TaskDetailPanel, {
      ...
      snap.showNewTask && h11(NewTaskModal, {
        transport,
      ...
      snap.showEdit && snap.editTask && h11(EditTaskModal, {
        task: snap.editTask,
        options: snap.options,
        onClose: function() {
      ...
      snap.showConfig && h11(ConfigPanel, {
        config: snap.config,
        options: snap.options,
        onClose: function() {
  ...
  function CompactHeader(props) {
    ...
    var total = snap.tasks.filter(function(t6) {
      return !t6.archivedAt;
    }).length;
    return h11(
      "header",
      { className: "flex-shrink-0 flex items-center gap-3 px-4 py-2.5 border-b border-aq-line bg-aq-paper" },
      h11(
        "div",
        ...
        h11(
          ...
          h11("span", { className: "w-4 h-4 flex-shrink-0", dangerouslySetInnerHTML: { __html: iconHtml("list") } }),
          "\u4EFB\u52A1\u961F\u5217"
        ),
        total > 0 && h11(
          "span",
          { className: "text-xs text-aq-muted" },
          running > 0 ? running + " \u8FD0\u884C\u4E2D" : pending > 0 ? pending + " \u7B49\u5F85\u4E2D" : total + " \u4E2A\u4EFB\u52A1"
        )
      ),
      props.message && h11("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 px-3 py-1.5 rounded-b-lg bg-aq-navy text-white text-xs shadow-lg z-50" }, props.message),
      h11("button", { className: "aq-btn aq-btn-ghost h-7 text-xs", onClick: props.onScan, title: "\u7ACB\u5373\u626B\u63CF\u6536\u4EF6\u7BB1", dangerouslySetInnerHTML: { __html: iconHtml("scan") + " \u626B\u63CF" } }),
      h11("button", { className: "aq-btn aq-btn-ghost h-7 text-xs", onClick: props.onConfig, title: "\u8FD0\u884C\u8BBE\u7F6E", dangerouslySetInnerHTML: { __html: iconHtml("gear") } }),
      h11("button", { className: "aq-btn aq-btn-ghost h-7 text-xs", onClick: props.onClose, dangerouslySetInnerHTML: { __html: iconHtml("close") + " \u5173\u95ED" } })
    );
  }
  function QuickStats(props) {
    ...
    return h11(
      "div",
      { className: "flex-shrink-0 grid grid-cols-4 border-b border-aq-line" },
      h11(StatCell, { label: "\u8FD0\u884C\u4E2D", value: String(running), color: running > 0 ? "text-aq-blue" : "text-aq-faint" }),
      h11(StatCell, { label: "\u7B49\u5F85\u4E2D", value: String(pending), color: pending > 0 ? "text-aq-muted" : "text-aq-faint" }),
      h11(StatCell, { label: "24h \u5B8C\u6210", value: String(done24h), color: done24h > 0 ? "text-aq-green" : "text-aq-faint" }),
      h11(StatCell, { label: "\u9694\u79BB", value: isolation.verified ? "\u5DF2\u542F\u7528" : "\u5F85\u786E\u8BA4", color: isolation.verified ? "text-aq-green" : "text-aq-amber" })
    );
  }
  function StatCell(props) {
    return h11(
      "div",
      { className: "flex flex-col items-center py-2 px-2 border-r border-aq-line last:border-r-0" },
      h11("span", { className: "text-base font-bold leading-none " + props.color }, props.value),
      h11("span", { className: "text-xs text-aq-faint mt-0.5" }, props.label)
    );
  }
  function CompactFilters(props) {
    ...
    return h11(
      "div",
      { className: "flex-shrink-0 flex items-center gap-2 px-4 py-2 border-b border-aq-line" },
      h11(
        "div",
        { className: "flex-1" },
        h11(
      ...
      h11(
        "div",
        { className: "flex gap-0.5 p-0.5 rounded-lg bg-aq-surface-alt border border-aq-line" },
        tabs.map(function(t6) {
          return h11("button", {
            key: t6[0],
            className: "px-2.5 py-1 rounded-md text-xs font-semibold transition " + (snap.filter === t6[0] ? "bg-aq-paper text-aq-ink shadow-sm" : "text-aq-muted hover:text-aq-ink"),
            onClick: function() {
              props.onFilter(t6[0]);
            }
          }, t6[1], t6[2] > 0 ? h11("span", { className: "ml-1 opacity-60" }, t6[2]) : null);
        })
      ),
      h11("button", {
  ...
  function CompactTaskList(props) {
    if (props.snap.loading) {
      return h11(
        ...
        h11("div", { className: "w-5 h-5 border-2 border-aq-line-2 border-t-aq-blue rounded-full animate-spin" }),
        h11("span", { className: "text-sm text-aq-muted" }, "\u6B63\u5728\u8BFB\u53D6\u4EFB\u52A1\u8D26\u672C\u2026")
      );
    }
    if (!props.tasks.length) {
      return h11(
        ...
        h11("p", { className: "text-sm text-aq-muted" }, "\u8FD8\u6CA1\u6709\u4EFB\u52A1"),
        h11("button", { className: "aq-btn aq-btn-primary text-xs", onClick: function() {
    ...
    return h11(
      ...
      h11(
        ...
        h11(
          "colgroup",
          null,
          h11("col", { style: { width: "32px" } }),
          h11("col", null),
          h11("col", { style: { width: "48px" } }),
          h11("col", { style: { width: "56px" } }),
          h11("col", { style: { width: "130px" } }),
          h11("col", { style: { width: "100px" } })
        ),
        h11(
          "thead",
          null,
          h11(
            ...
            h11("th", { className: "pl-4 py-1.5 text-xs" }),
            h11("th", { className: "text-left py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide" }, "\u4EFB\u52A1"),
            h11("th", { className: "py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide text-center" }, "\u7C7B\u578B"),
            h11("th", { className: "py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide text-center" }, "\u8C03\u5EA6"),
            h11("th", { className: "pr-4 py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide text-right" }, "\u72B6\u6001"),
            h11("th", { className: "pr-4 py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide text-right" }, "\u64CD\u4F5C")
          )
        ),
        h11(
          "tbody",
          ...
          props.tasks.map(function(task) {
            return h11(TaskRow, {
              ...
              onUnread: function(k5) {
                props.controller.markRead(k5, false);
              },
  ...
  function TaskRow(props) {
    ...
    var recentLine = task.status === "pending" ? pendingReasonCompact(task, props.snap) : task.status === "running" ? task.foregroundPaused ? "\u5DF2\u6682\u505C" : "\u7B2C " + (task.currentRound || 0) + " \u8F6E \xB7 " + elapseStr(task.startedAt) : task.status === "done" ? (task.currentRound ? "\u7B2C " + task.currentRound + " \u8F6E\u5B8C\u6210" : "\u5DF2\u5B8C\u6210") + " \xB7 " + (task.updatedAt ? timeAgo(task.updatedAt) : "") : task.status === "failed" ? task.lastError ? String(task.lastError).slice(0, 40) : "\u5DF2\u5931\u8D25" : task.status === "stopped" ? "\u5DF2\u505C\u6B62" : task.lastError ? String(task.lastError).slice(0, 40) : task.updatedAt ? timeAgo(task.updatedAt) : "-";
    ...
    return h11(
      "tr",
      {
        className: "hover:bg-aq-surface-alt cursor-pointer transition group align-top " + (props.selected ? "bg-aq-blue-soft" : ""),
        onClick: openRow
      },
      h11(
        "td",
        { className: "pl-4 py-1.5 align-top", onClick: function(e7) {
          e7.stopPropagation();
        }, style: { fontSize: "12px" } },
        h11(
          Ke,
          ...
          h11(
            ...
            props.selected && h11(
              ...
              h11("path", { d: "M2.5 6l2.5 2.5 4.5-4.5", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })
            )
          )
        )
      ),
      h11(
        "td",
        { className: "py-1.5 align-top break-words", style: { fontSize: "12px" } },
        h11(
          "div",
          { className: "flex items-center gap-1.5" },
          h11("span", { className: "font-semibold text-aq-ink leading-snug" }, attention ? "! " + task.key : task.key),
          summary && h11("span", { className: "text-aq-muted leading-snug" }, "\xB7 " + summary)
        )
      ),
      h11("td", { className: "py-1.5 text-aq-faint text-center align-top", style: { fontSize: "12px" } }, typeInfo.label),
      h11(
        "td",
        { className: "py-1.5 text-aq-faint text-center align-top", style: { fontSize: "12px" } },
        plan,
        nextRun && h11("div", { className: "text-aq-faint" }, nextRun)
      ),
      h11(
        "td",
        { className: "py-1.5 pr-4 text-right align-top " + (attention ? "text-aq-amber font-medium" : "text-aq-faint"), style: { fontSize: "12px" } },
        recentLine
      ),
      h11(
        "td",
        { className: "py-1.5 pr-4 text-right align-top", style: { fontSize: "12px" } },
        h11(
          "div",
          { className: "flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition" },
          task.status === "running" && task.stopPending !== true && !task.archivedAt && h11("button", { className: "aq-btn aq-btn-ghost h-6 px-2 text-xs text-aq-red", onClick: function(e7) {
            e7.stopPropagation();
            props.onAction("stop", task.key);
          } }, "\u505C\u6B62"),
          task.status === "pending" && !task.archivedAt && h11("button", { className: "aq-btn aq-btn-ghost h-6 px-2 text-xs", onClick: function(e7) {
            e7.stopPropagation();
            props.onEdit(task.key);
          } }, "\u7F16\u8F91"),
          actions.indexOf("rerun") >= 0 && h11("button", { className: "aq-btn aq-btn-ghost h-6 px-2 text-xs text-aq-green", onClick: function(e7) {
            e7.stopPropagation();
            props.onAction("rerun", task.key);
          } }, "\u91CD\u8DD1"),
          actions.indexOf("archive") >= 0 && h11("button", { className: "aq-btn aq-btn-ghost h-6 px-2 text-xs", onClick: function(e7) {
            e7.stopPropagation();
            props.onAction("archive", task.key);
          } }, "\u5F52\u6863"),
          task.archivedAt && h11("button", { className: "aq-btn aq-btn-ghost h-6 px-2 text-xs", onClick: function(e7) {
            e7.stopPropagation();
            props.onAction("restore", task.key);
          } }, "\u8FD8\u539F"),
          task.status === "pending" && !task.archivedAt && h11("button", { className: "aq-btn aq-btn-ghost h-6 px-2 text-xs text-aq-red", onClick: function(e7) {
            e7.stopPropagation();
            props.onAction("delete", task.key);
          } }, "\u5220\u9664"),
          sessionId && !task.archivedAt && h11("button", { className: "aq-btn aq-btn-ghost h-6 px-2 text-xs", onClick: function(e7) {
            e7.stopPropagation();
            props.controller.closeBoard();
  ...
  function taskActions(task) {
    var a15 = [];
    if (["done", "failed", "stopped", "interrupted"].indexOf(task.status) >= 0 && !task.archivedAt) a15.push("rerun");
    if (task.status !== "running" && !task.archivedAt) a15.push("archive");
    return a15;
  }
    ...
    return h12(
      ...
      h12(
        ...
        h12(
          ...
          h12(Workstation, { controller, transport, sessions, compact: true })
        )
      ),
      // 底部小图标（Dock）
      h12(
        ...
        h12(
          ...
          h12("span", { style: { position: "absolute", inset: 0, borderRadius: "50%", backgroundColor: dotColor, opacity: 0.75 } }),
          snap.metrics.running > 0 && h12("span", { style: { position: "absolute", inset: 0, borderRadius: "50%", backgroundColor: dotColor, opacity: 0.3, animation: "ping 1s cubic-bezier(0, 0, 0.2, 1) infinite" } })
        ),
        h12(
          "span",
          { style: { color: "#667085", transition: "color 0.2s" } },
          h12("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.5", dangerouslySetInnerHTML: { __html: iconHtml("clock").replace(/<svg[^>]*>/, "").replace(/<\/svg>/, "") } })
        ),
        h12("span", { style: { fontSize: "14px", fontWeight: "600", color: "#344054", transition: "color 0.2s", display: "none" } }, boardOpen ? "\u5173\u95ED" : "\u4EFB\u52A1\u961F\u5217"),
        totalBadge > 0 && h12("span", {
          style: {
            position: "absolute",
            top: "-6px",
            right: "-6px",
