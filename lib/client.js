    ...
    return h7(
      ...
      h7(
        ...
        h7(
          ...
          {
            transition: true,
            className: (isDrawer ? "h-full w-[min(880px,94vw)] bg-aq-paper shadow-2xl transition duration-200 ease-out data-[closed]:translate-x-4 data-[closed]:opacity-0 flex flex-col" : "w-[800px] rounded-2xl bg-aq-paper shadow-2xl border border-aq-line transition duration-200 ease-out data-[closed]:scale-95 data-[closed]:opacity-0 flex flex-col overflow-hidden") + (props.className ? " " + props.className : ""),
