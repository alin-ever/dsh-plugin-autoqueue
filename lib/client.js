...
`)), [];
  ...
  function DialogShell(props) {
    ...
    return h7(
      ...
      h7(
        "div",
        { className: isDrawer ? "fixed inset-0 flex justify-end" : "fixed inset-0 flex items-center justify-center p-4 overflow-y-auto" },
        h7(
          ze,
          {
            transition: true,
            className: (isDrawer ? "h-full w-[min(880px,94vw)] bg-aq-paper shadow-2xl transition duration-200 ease-out data-[closed]:translate-x-4 data-[closed]:opacity-0" : "w-[800px] rounded-2xl bg-aq-paper shadow-2xl border border-aq-line transition duration-200 ease-out data-[closed]:scale-95 data-[closed]:opacity-0 flex flex-col") + (props.className ? " " + props.className : ""),
          ...
          h7(
            ...
            h7("div", { className: "flex-1 min-h-0" }, props.children)
          )
        )
      )
    );
  ...
  function NewTaskModal(props) {
    ...
    return h9(
      ...
      h9(
        "form",
        { className: "flex flex-col px-6 pb-6", onSubmit: handleSubmit },
        ...
        !showTemplates[0] && h9(
          ...
          fromTemplate[0] ? h9(
            ...
            h9("span", { className: "text-sm text-aq-muted" }, "\u76F4\u63A5\u586B\u5199\u4EFB\u52A1\u5185\u5BB9"),
            h9("button", { type: "button", className: "text-sm text-aq-blue hover:underline", onClick: loadTemplates }, "\u4ECE\u6A21\u677F\u5F00\u59CB")
          ),
        ...
        h9(
          ...
          h9("button", { type: "button", className: "aq-btn aq-btn-ghost", onClick: loadTemplates, disabled: submitting[0] }, "\u4ECE\u6A21\u677F\u5F00\u59CB"),
  ...
  function TemplateManager(props) {
    ...
    return h9(
      ...
      h9(
        ...
        editing[0] !== null ? h9(
          "form",
          { className: "flex-1 overflow-y-auto px-6 py-4", onSubmit: handleSave },
          saveError[0] && h9("div", { className: "p-3 mb-4 rounded-lg bg-aq-red-soft text-sm text-aq-red" }, saveError[0]),
  ...
  function QuickStats(props) {
    ...
    return h10(
      "div",
      { className: "flex-shrink-0 grid grid-cols-3 border-b border-aq-line" },
      h10(StatCell, { label: "\u8FD0\u884C\u4E2D", value: String(running), color: running > 0 ? "text-aq-blue" : "text-aq-faint" }),
      h10(StatCell, { label: "\u7B49\u5F85\u4E2D", value: String(pending), color: pending > 0 ? "text-aq-muted" : "text-aq-faint" }),
      h10(StatCell, { label: "24h \u5B8C\u6210", value: String(done24h), color: done24h > 0 ? "text-aq-green" : "text-aq-faint" })
    );
  }
  function StatCell(props) {
    return h10(
      ...
      h10("span", { className: "text-base font-bold leading-none " + props.color }, props.value),
      h10("span", { className: "text-xs text-aq-faint mt-0.5" }, props.label)
    );
  }
  function NavCategories(props) {
    ...
    return h10(
      "div",
      { className: "flex-shrink-0 flex gap-0 px-4 py-1.5 border-b border-aq-line overflow-x-auto" },
      cats.map(function(c11) {
        var active2 = snap.navGroup === c11[0] || snap.navGroup === "all" && c11[0] === "all";
        return h10("button", {
          key: c11[0],
          className: "px-2.5 py-1 rounded-md text-xs font-semibold whitespace-nowrap transition " + (active2 ? "bg-aq-blue text-white" : "text-aq-muted hover:text-aq-ink hover:bg-aq-surface-alt"),
          onClick: function() {
            props.onNav(c11[0]);
          }
    ...
    return h10(
      ...
      h10(
        ...
        h10(
          ...
          h10("col", null),
          h10("col", { style: { width: "90px" } }),
          h10("col", { style: { width: "80px" } }),
        ...
        h10(
          ...
          h10(
            ...
            h10("th", { className: "text-left py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide" }, "\u4EFB\u52A1"),
            h10("th", { className: "py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide text-center" }, "\u8C03\u5EA6"),
            h10("th", { className: "pr-4 py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide text-right" }, "\u72B6\u6001"),
            h10("th", { className: "pr-4 py-1.5 text-xs font-semibold text-aq-faint uppercase tracking-wide" }, "\u64CD\u4F5C")
          )
        ),
        h10(
          "tbody",
  ...
  function TaskRow(props) {
    ...
    return h10(
      ...
      h10(
        "td",
        { className: "pl-4 pr-2 py-2 align-middle", onClick: function(e7) {
          e7.stopPropagation();
        } },
        h10(
          Ke,
      ...
      h10(
        "td",
        { className: "py-2 align-middle break-words", style: { fontSize: "12px" } },
        h10(
          "div",
          { className: "flex items-center gap-1.5" },
          h10("span", { className: "font-semibold text-aq-ink leading-snug" }, attention ? "! " + task.key : task.key),
          summary && h10("span", { className: "text-aq-muted leading-snug truncate" }, "\xB7 " + summary)
        )
      ),
      h10(
        "td",
        { className: "py-2 text-aq-faint text-center align-middle", style: { fontSize: "12px" } },
        plan
      ),
      h10(
        "td",
        { className: "py-2 pr-4 text-right align-middle", style: { fontSize: "12px" } },
        h10(
          "div",
          { className: "flex items-center justify-end gap-1.5" },
          h10("span", { className: "inline-block w-1.5 h-1.5 rounded-full flex-shrink-0", style: { backgroundColor: statusColor } }),
          h10("span", { className: attention ? "text-aq-amber font-medium" : "text-aq-faint" }, statusLabel)
        )
      ),
      h10(
        "td",
        { className: "py-2 pr-4 align-middle", style: { fontSize: "12px" } },
        h10(
          "div",
          ...
          task.status === "pending" && !task.archivedAt && h10("button", { style: Object.assign({}, actionBtnStyle, { color: "var(--aq-red, #b42318)" }), className: "hover:bg-aq-red-soft", onClick: function(e7) {
            e7.stopPropagation();
  ...
  function FloatingDock(props) {
    ...
    return h11(
      ...
      h11(
        ...
        h11("span", { style: { width: "8px", height: "8px", borderRadius: "50%", backgroundColor: dotColor, flexShrink: 0 } }),
        h11("span", { style: { fontSize: "13px", fontWeight: "600", color: "var(--aq-ink, #344054)", lineHeight: 1 } }, "\u4EFB\u52A1\u961F\u5217"),
        activeCount > 0 ? h11("span", { style: { fontSize: "12px", fontWeight: "600", color: "var(--aq-blue, #155eef)", lineHeight: 1 } }, String(activeCount)) : unreadCount > 0 ? h11("span", { style: { fontSize: "12px", fontWeight: "600", color: "var(--aq-muted, #667085)", lineHeight: 1 } }, String(unreadCount)) : null
      )
    );
  }
