(() => {
  ...
  function NewTaskModal(props) {
    ...
    var reuseSession = window.__React.useState(true);
    ...
    return h2(
      ...
      h2(
        ...
        cron[0] && h2(CheckField, { checked: reuseSession[0], onChange: reuseSession[1], label: "\u590D\u7528\u4F1A\u8BDD\uFF08\u5FAA\u73AF\u4EFB\u52A1\u5728\u540C\u4E00\u4F1A\u8BDD\u4E2D\u7EE7\u7EED\u6267\u884C\uFF0C\u4FDD\u7559\u4E0A\u4E0B\u6587\uFF09" }),
        h2(
          Disclosure,
  ...
  function EditTaskModal(props) {
    ...
    var reuseSession = window.__React.useState(task.reuseSession === true);
    var advancedOpen = window.__React.useState(false);
    var notifyOpen = window.__React.useState(false);
    var error = window.__React.useState("");
    var submitting = window.__React.useState(false);
  ...
  function TaskRow(props) {
    ...
    var plan = task.cron ? cronToHuman(task.cron) + (task.reuseSession !== false ? " \xB7 \u590D\u7528\u4F1A\u8BDD" : "") : task.schedule ? formatIso(task.schedule) : "\u5373\u65F6\u6D3E\u53D1";
