...
var QUEUE_CSS = `
  ...
  .aq-modal select { cursor: pointer; }
...
function createComponents(React) {
  ...
  function CronField({ label, value, onChange, presets, placeholder, tip: tipText }) {
    const presetValue = presets.find((p) => p.value === value)?.value ?? "";
    return e(
      "div",
      null,
    ...
    return e(
      ...
      e(
        ...
        e(
          ...
          task.schedule ? ` \xB7 \u5B9A\u65F6: ${task.schedule}` : "",
  ...
  function ConfigPanel({ config, onUpdate, onSetConcurrency, onClose, options }) {
    ...
    return e(
      ...
      e(
        ...
        e(CronField, { label: "\u5168\u5C40\u622A\u6B62\u65F6\u95F4 (deadline)", value: defaultDeadline, onChange: setDefaultDeadline, presets: DEADLINE_PRESETS, placeholder: "0 21 * * *", tip: "\u5230\u70B9\u5F3A\u5236\u505C\u6B62\u6240\u6709\u8FD0\u884C\u4E2D\u4EFB\u52A1\uFF08cron \u8868\u8FBE\u5F0F\uFF09" }),
        ...
        e("div", { style: { display: "flex", gap: "8px", alignItems: "center" } },
          ...
          e("label", { style: { display: "flex", alignItems: "center", gap: "8px", cursor: "pointer", whiteSpace: "nowrap", margin: 0 } },
            e("input", { type: "checkbox", checked: autoArchive, onChange: (ev) => setAutoArchive(ev.target.checked), style: { width: "auto", margin: 0 } }),
            "\u81EA\u52A8\u5F52\u6863",
        ...
        e("div", { className: "aq-row" },
          e("div", null,
            e("label", null, "\u6536\u4EF6\u7BB1\u76EE\u5F55", tip("\u626B\u63CF\u6536\u4EF6\u7BB1\u7684\u76EE\u5F55\u8DEF\u5F84\uFF0C\u9ED8\u8BA4\u4E3A inbox")),
            e("input", { value: queueDir, onChange: (ev) => setQueueDir(ev.target.value), placeholder: "\u9ED8\u8BA4\u4E3A inbox" })
          ),
          e("div", null,
            e("label", null, "\u9ED8\u8BA4\u5DE5\u4F5C\u533A", tip("\u9ED8\u8BA4\u5DE5\u4F5C\u533A ID\uFF0C\u4E0D\u8BBE\u7F6E\u5219\u81EA\u52A8\u521B\u5EFA\u65B0\u5DE5\u4F5C\u533A")),
            e("input", { value: workspace, onChange: (ev) => setWorkspace(ev.target.value), placeholder: "\u4E0D\u8BBE\u7F6E\u5219\u81EA\u52A8\u521B\u5EFA" })
          )
        ),
        e("label", null, "\u9ED8\u8BA4 Agent \u9884\u8BBE", tip("\u9ED8\u8BA4\u4F7F\u7528\u7684 Agent \u9884\u8BBE\u540D\u79F0")),
        e("input", { value: agentPreset, onChange: (ev) => setAgentPreset(ev.target.value), placeholder: "\u4E0D\u8BBE\u7F6E\u5219\u4F7F\u7528\u9ED8\u8BA4" }),
        e(
          "div",
          { className: "aq-modal-actions" },
          e("button", { className: "aq-btn", onClick: onClose }, "\u53D6\u6D88"),
...
var SIDEBAR_ICON = '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="3" x2="9" y2="9"/><circle cx="12" cy="13" r="2"/></svg>';
