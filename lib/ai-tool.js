...
function registerCreateTask(ctx, apiRequest) {
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      provider: { type: "string", description: "AI provider to use for task execution. If omitted, inherits from the current session's provider. You can call `autoqueue_list_models` first to discover available providers and models." },
      model: { type: "string", description: "AI model to use for task execution. If omitted, inherits from the current session's model. You can call `autoqueue_list_models` first to discover available models." },
...
function registerListModels(ctx) {
  ctx.tools.register(defineTool({
    ...
    description: "List available AI providers and models that can be used for autoqueue tasks. Call this before autoqueue_create_task if you want to specify a non-default model. The current session's model is used by default if you do not override.",
    parameters: {},
